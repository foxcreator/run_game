...
export const GAME_CONFIG = {
    ...
    CHASERS: {
        ...
        BLOCKER: {
            SPEED: 15,                    // Базова швидкість руху (190-210 згідно MVP, пікселі/сек)
        ...
        STICKER: {
            SPEED: 17,                    // Базова швидкість руху (230-255 згідно MVP, пікселі/сек)
    ...
    PICKUPS: {
        ...
        // Бонуси
        BONUSES: {
            MAX_COUNT_ON_MAP: 3,           // Максимальна кількість бонусів на всій карті
            SPAWN_CHANCE: 0.3              // Шанс спавну бонусу замість монети (30%)
        },
        // Енергетик
        ENERGY_DRINK: {
            STAMINA_GAIN: 35               // Кількість стаміни що відновлюється
        },
        // Скутер
        SCOOTER: {
            SPEED_MULTIPLIER: 0.5,         // Додатковий множник швидкості (+50%)
            DURATION: 2000,                 // Тривалість ефекту (мс)
            IMMUNITY_TO_SOFT_CROWD: true   // Імунітет до SoftCrowd
        },
        // Жарт
        JOKE: {
            CAPTURE_REDUCTION: 30,         // Зменшення capture
            ENEMY_SPEED_MULTIPLIER: 0.7,   // Множник швидкості ворогів (70%)
            DURATION: 1000                  // Тривалість ефекту для ворогів (мс)
        },
        // Димова хмарка
        SMOKE_CLOUD: {
            DURATION: 1200                  // Тривалість "втрати лока" для ворогів (мс)
        }
    }
};
