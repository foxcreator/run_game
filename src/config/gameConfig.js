...
export const GAME_CONFIG = {
    ...
    OBSTACLES: {
        ...
        MOVING_BUS: {
            WIDTH: 60, // Ширина авто (пікселі) - використовується як fallback
            HEIGHT: 30, // Висота авто (пікселі) - використовується як fallback
            DISPLAY_WIDTH: 30, // Ширина для відображення (null = використовувати оригінальний розмір текстури)
            DISPLAY_HEIGHT: 60, // Висота для відображення (null = використовувати оригінальний розмір текстури)
    ...
    CHASERS: {
        ...
        STICKER: {
            SPEED: 18,                    // Базова швидкість руху (230-255 згідно MVP, пікселі/сек)
