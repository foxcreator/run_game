...
export const GAME_CONFIG = {
    ...
    PLAYER: {
        ...
        STAMINA_MAX: 1000,                    // Максимальна стаміна (0-100)
    ...
    CAPTURE: {
        MAX: 1000000,                           // Максимальне значення capture (0-100)
    ...
    PICKUPS: {
        ...
        SCOOTER: {
            ...
            WIDTH: 150,                      // Ширина пікапа (пікселі)
    ...
    AUDIO: {
        ...
        AMBIENCE: {
            BIRDS_VOLUME: 0.40,             // Гучність звуку птахів (0.0 - 1.0)
            WIND_VOLUME: 0.60,               // Гучність звуку вітру (0.0 - 1.0)
    ...
    BONUSES: {
        ...
        SPINNER: {
            ID: 'spinner',
            NAME: 'Вертушка',
            DESCRIPTION: 'Відкидає ворогів та заморожує їх на 7 секунд.',
            KEY: 'Key1', // Клавіша 1
            PRICE: 450,
            COOLDOWN: 45000, // 45 с
            DURATION: 7000,  // 7 с (заморозка)
            RADIUS: 200,     // Радіус дії
            PUSH_FORCE: 400, // Сила відкидання
            ICON: 'bonus_spinner',
            SOUND: 'bonus_spinner_activate'
        },
        // 2. Офіснік (Magnet)
        MAGNET: {
            ID: 'magnet',
            NAME: 'Офіснік',
            DESCRIPTION: 'Магніт: Залучає "інвестиції" (монети) в радіусі дії.',
            KEY: 'Key2', // Клавіша 2
            PRICE: 300,
            COOLDOWN: 60000, // 60 с
            DURATION: 10000, // 10 с
            RADIUS: 300,     // Радіус притягування
            SPEED: 500,      // Швидкість польоту монет
            ICON: 'bonus_officnik',
            SOUND: 'bonus_magnet_activate'
        },
        // 3. Газовий балончик 'Терен-4' (Gas)
        GAS: {
            ID: 'gas',
            NAME: 'Терен-4',
            DESCRIPTION: 'Пастка: Хмара газу, що сповільнює ворогів в 2 рази.',
            KEY: 'Key3', // Клавіша 3
            PRICE: 200,
            COOLDOWN: 30000, // 30 с
            DURATION: 5000,  // 5 с (дія на ворога)
            CLOUD_DURATION: 10000, // 10 с (час життя хмари)
            SLOWDOWN_FACTOR: 0.5,  // Сповільнення (0.5 = 50% швидкості)
            RADIUS: 100,     // Радіус хмари
            ICON: 'bonus_teren',
            SOUND: 'bonus_gas_activate'
        },
        // 4. Посвідчення депутата (Immunity)
        DEPUTY: {
            ID: 'deputy',
            NAME: 'Депутат',
            DESCRIPTION: 'Імунітет: Вороги вас "не бачать" і не чіпають.',
            KEY: 'Key4', // Клавіша 4
            PRICE: 800,
            COOLDOWN: 120000, // 2 хв
            DURATION: 5000,   // 5 с
            ICON: 'bonus_deputy',
            SOUND: 'bonus_shield_activate'
        },
        // 5. Кава 'Бандерівська' (Stamina)
        COFFEE: {
            ID: 'coffee',
            NAME: 'Кава',
            DESCRIPTION: 'Стаміна: Миттєве відновлення та нескінченний біг.',
            KEY: 'Key5', // Клавіша 5
            PRICE: 100,
            COOLDOWN: 40000, // 40 с
            DURATION: 10000, // 10 с (нескінченна стаміна)
            REGEN_AMOUNT: 100, // % відновлення
            ICON: 'bonus_coffee',
            SOUND: 'bonus_powerup'
        },
        // 6. Шматок Сала (Lure)
        SALO: {
            ID: 'salo',
            NAME: 'Сало',
            DESCRIPTION: 'Приманка: Вороги збігаються скуштувати.',
            KEY: 'Key6', // Клавіша 6
            PRICE: 250,
            COOLDOWN: 45000, // 45 с
            DURATION: 5000,  // 5 с (час поїдання)
            LURE_DURATION: 15000, // 15 с (час життя сала на землі)
            RADIUS: 400,     // Радіус приманювання
            ICON: 'bonus_salo',
            SOUND: 'bonus_throw'
        },
        // 7. Бронік 'Варта' (Shield)
        ARMOR: {
            ID: 'armor',
            NAME: 'Бронік',
            DESCRIPTION: 'Щит: Захищає від одного удару або зіткнення.',
            KEY: 'Key7',   // Клавіша 7
            PRICE: 500,
            COOLDOWN: 60000, // 60 с
            DURATION: 15000, // 15 с (максимальний час дії щита)
            HITS: 1,         // Кількість ударів
            ICON: 'bonus_armor',
            SOUND: 'bonus_armor_equip'
        },
        // 8. Магнат 'Бізнес' (Money x2)
        MAGNATE: {
            ID: 'magnate',
            NAME: 'Бізнес-ланч',
            DESCRIPTION: 'Інвестиції: Подвійний дохід з усіх джерел.',
            KEY: 'Key8',   // Клавіша 8
            PRICE: 1000,
            COOLDOWN: 120000, // 2 хв
            DURATION: 15000, // 15 с
            MULTIPLIER: 2,   // Множник
            ICON: 'bonus_magnate',
            SOUND: 'bonus_powerup' // Reusing sound for now
        }
    },
