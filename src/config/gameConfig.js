...
export const GAME_CONFIG = {
    ...
    AUDIO: {
        ...
        AMBIENCE: {
            BIRDS_VOLUME: 0.35,             // Гучність звуку птахів (0.0 - 1.0)
            WIND_VOLUME: 0.3,               // Гучність звуку вітру (0.0 - 1.0)
            RIVER_MAX_VOLUME: 0.5,          // Максимальна гучність звуку річки (0.0 - 1.0)
